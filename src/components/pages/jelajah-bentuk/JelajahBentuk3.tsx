...
const Circle: React.FC<{
    ...
    <div
        className={`inline-block transition-all duration-300 rounded-full ${isDragging ? 'rotate-3 scale-110' :
...
const HeartShape: React.FC<{
    ...
    <div
        className={`inline-flex items-center justify-center transition-all duration-300 ${isDragging ? 'rotate-3 scale-110' :
                isSelected ? 'scale-110 ring-4 ring-yellow-400 ring-offset-2' :
                    'hover:scale-105'
            }`}
        style={{
