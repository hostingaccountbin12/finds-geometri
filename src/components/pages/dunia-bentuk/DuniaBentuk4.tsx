...
//Tempat
import BoxBasket from "@/assets/icons/dunia-bentuk/dunia-bentuk-4/BoxBasket.png"
import BoxCermin from "@/assets/icons/dunia-bentuk/dunia-bentuk-4/BoxCermin.png"
import BoxKemah from "@/assets/icons/dunia-bentuk/dunia-bentuk-4/BoxKemah.png"
import BoxSendal from "@/assets/icons/dunia-bentuk/dunia-bentuk-4/BoxSendal.png"
...
const shapeSlots: ShapeSlot[] = [
    { id: 1, shape: "round", image: BoxBasket, bgColor: "bg-blue-500" },
    { id: 2, shape: "oval", image: BoxSendal, bgColor: "bg-blue-500" },
    { id: 3, shape: "triangle", image: BoxKemah, bgColor: "bg-blue-500" },
    { id: 4, shape: "love", image: BoxCermin, bgColor: "bg-blue-500" },
];

export default function DuniaBentuk4(): JSX.Element {
