...
import Atap from "@/assets/icons/mini-games/mini-games-1/Atap.webp"
import Bola from "@/assets/icons/mini-games/mini-games-1/Bola.webp"
import Buku from "@/assets/icons/mini-games/mini-games-1/Buku.webp"
import Cermin from "@/assets/icons/mini-games/mini-games-1/Cermin.webp"
import Eskrim from "@/assets/icons/mini-games/mini-games-1/Eskrim.webp"
...
interface GameItem {
    id: number;
    name: string;
    shape: 'triangle' | 'circle' | 'rectangle' | 'cylinder' | 'trapezoid' | 'oval'
    icon: any;
    selected: boolean;
    matched: boolean;
}
...
export default function MiniGames1(): JSX.Element {
    ...
    const gameItems: GameItem[] = [
        ...
        { id: 2, name: 'Bola', shape: 'circle', icon: Bola, selected: false, matched: false },
