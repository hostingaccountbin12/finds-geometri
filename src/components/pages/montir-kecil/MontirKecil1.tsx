...
import CorrectCar from "@/assets/icons/montir-kecil/CorrectCar.png"
import FirstCar from "@/assets/icons/montir-kecil/FirstCar.gif"

import BulatOrange from "@/assets/icons/montir-kecil/BulatOrange.png"
import LovePink from "@/assets/icons/montir-kecil/LovePink.gif"
import PersegiUngu from "@/assets/icons/montir-kecil/PersegiUngu.gif"
import SegitigaMerah from "@/assets/icons/montir-kecil/SegitigaMerah.gif"


export default function MontirKecil1() {
    ...
    const handleShapeClick = (shape: string) => {
        ...
        if (shape === 'circle') {
            ...
            setTimeout(() => {
                ...
                navigateTo("montir-kecil-2"); // Navigasi ke level selanjutnya
            }, 2000);
        } else {
            setGameState('wrong');
    ...
    const CarDisplay = ({ showWheels }: { showWheels: boolean }) => (
        <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <Image
                    src={showWheels ? CorrectCar : FirstCar}
                    alt={showWheels ? "Correct Car" : "Car without wheels"}
                    width={250}
                    height={120}
                    className="mx-auto"
                />
    ...
    const shapes = [
        { id: 'circle', image: BulatOrange, name: 'Circle' },
        { id: 'triangle', image: SegitigaMerah, name: 'Triangle' },
        { id: 'heart', image: LovePink, name: 'Heart' },
