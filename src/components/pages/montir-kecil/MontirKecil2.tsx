...
import CorrectKereta from "@/assets/icons/montir-kecil/CorrectKereta.png"
import FirstKereta from "@/assets/icons/montir-kecil/FirstKereta.gif"

import SegitigaBiru from "@/assets/icons/montir-kecil/SegitigaBiru.gif"
import KotakKuning from "@/assets/icons/montir-kecil/KotakKuning.gif"
import JajarAbu from "@/assets/icons/montir-kecil/JajarAbu.gif"
import StarPink from "@/assets/icons/montir-kecil/StarPink.gif"


export default function MontirKecil2() {
    ...
    const handleShapeClick = (shape: string) => {
        ...
        if (shape === 'parallelogram') {
            ...
            setTimeout(() => {
                updateLevelMontirKecil(3); // Update level ke 2
                navigateTo("montir-kecil-3"); // Navigasi ke level selanjutnya
            }, 2000);
        } else {
            setGameState('wrong');
    ...
    const CarDisplay = ({ showWheels }: { showWheels: boolean }) => (
        <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <Image
                    src={showWheels ? CorrectKereta : FirstKereta}
    ...
    const shapes = [
        { id: 'triangle', image: SegitigaBiru, name: 'Triangle' },
        { id: 'square', image: KotakKuning, name: 'Square' },
        { id: 'parallelogram', image: JajarAbu, name: 'Parallelogram' },
        ...
        <div className="relative w-full h-screen overflow-hidden flex flex-col">
            ...
            <div className="pt-8 text-center relative z-10">
                ...
                <p className="text-3xl text-black font-semibold">
                    Manakah bentuk atap kereta yang tepat?
                </p>
            </div>
