...
export type GameState = {
  ...
  // Instruction playing state
  isPlayingInstructionDuniaBentuk: boolean;
};
...
export type GameAction =
  ...
  | {
      type: "SET_PLAYING_INSTRUCTION_DUNIA_BENTUK";
...
const defaultGameState: GameState = {
  ...
  isPlayingInstructionDuniaBentuk: false,
};
...
const gameReducer = (state: GameState, action: GameAction): GameState => {
  ...
  switch (action.type) {
    ...
    case "SET_JELAJAH_BENTUK_FINISHED":
      newState = {
        ...state,
        isJelajahBentukFinished: action.payload.isFinished,
      };
      break;
    ...
    case "SET_MARI_BERKREASI_FINISHED":
      ...
      break;
    case "SET_PLAYING_INSTRUCTION_DUNIA_BENTUK":
      newState = {
        ...state,
        isPlayingInstructionDuniaBentuk: action.payload.isPlaying,
      };
      break;
    case "RESET_GAME":
...
export const useGameState = () => {
  ...
  return {
    ...
    updateLevelDuniaBentuk: (level: number) =>
      context.dispatch({
        type: "UPDATE_LEVEL_DUNIA_BENTUK",
        payload: { level },
      }),
    updateLevelJelajahBentuk: (level: number) =>
      context.dispatch({
        type: "UPDATE_LEVEL_JELAJAH_BENTUK",
        payload: { level },
      }),
    updateLevelMontirKecil: (level: number) =>
      context.dispatch({
        type: "UPDATE_LEVEL_MONTIR_KECIL",
        payload: { level },
      }),
    ...
    setDuniaBentukFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_DUNIA_BENTUK_FINISHED",
        payload: { isFinished },
      }),
    setJelajahBentukFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_JELAJAH_BENTUK_FINISHED",
        payload: { isFinished },
      }),
    setMontirKecilFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_MONTIR_KECIL_FINISHED",
        payload: { isFinished },
      }),
    setMiniGamesFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_MINI_GAMES_FINISHED",
        payload: { isFinished },
      }),
    setAyoMenyanyiFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_AYO_MENYANYI_FINISHED",
        payload: { isFinished },
      }),
    setMariBekreasFinished: (isFinished: boolean) =>
      context.dispatch({
        type: "SET_MARI_BERKREASI_FINISHED",
        payload: { isFinished },
      }),

    // Instruction playing function
    setPlayingInstructionDuniaBentuk: (isPlaying: boolean) =>
      context.dispatch({
        type: "SET_PLAYING_INSTRUCTION_DUNIA_BENTUK",
        payload: { isPlaying },
      }),
